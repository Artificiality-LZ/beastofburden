...
继承 BlockUI `BOWindow`（自管 hire/recall/workers + 模块侧栏；不继承会搬家的 MC `SpecialAssignmentModuleWindow`）。尺寸 190×352。873 市政厅原生侧栏；1214+ 经软 mixin 打开 `shouldRenderDefaultSidebar`，牛马页自建侧栏可切回其它页。
