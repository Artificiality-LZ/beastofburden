...
继承 BlockUI `BOWindow`（自管 hire/recall/workers + 模块侧栏）。尺寸 190×352。

**入口：** 市政厅左侧书签蜡封列（与资讯/权限/公民同一排），由 `AbstractWindowTownHallMixin` 在构造末尾注入「牛马」按钮；873/1214 共用。这不是模块侧栏——1214 市政厅会关掉模块侧栏以免和书签抢位。
